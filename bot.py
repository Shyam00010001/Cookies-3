...
# ============================================
# RAILWAY/TERMUX CONFIG - Environment Variables से लें
# ============================================
...
if not BOT_TOKEN:
    ...
    print("💡 Please set TELEGRAM_TOKEN in Railway Variables")
    exit(1)
...
def validate_cookie(cookie_dict):
    """Check if cookie is valid before saving"""
    try:
        token, expires = fetch_nftoken(cookie_dict)
        if token:
...
# ============================================
# 📄 FILE UPLOAD - VALIDATE BEFORE SAVING
# ============================================
